...
const TESTIMONIALS = [
  {
    ...
    quote:
      "Students often make formatting mistakes with inconsistent bullet points or font sizes. CraftCV’s automatic formatting and clean templates are a massive help.",
    name: "Ms. Spiegel",
    title: "Educator",
  },
  {
    ...
    quote:
      "I used CraftCV during my last job search and landed interviews at top tech companies thanks to its ATS-optimized LaTeX and modern resume layouts.",
    name: "Santi",
  ...
  },
  {
    ...
    quote:
      "Creating a professional resume on CraftCV is completely effortless. It saves hours compared to wrestling with Google Docs or Overleaf setup.",
    name: "Vivian",
